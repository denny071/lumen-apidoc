...
<head>
  ...
  <title>IFEC API 日志系统</title>

  <!-- Bootstrap -->
  <link rel="stylesheet" href="/document/bootstrap.min.css">
  <link rel="stylesheet" href="/document/dataTables.bootstrap.css">
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar" style="color:#6f42c1">
      <h1>IFEC API日志</h1>
      ...
      @else
        <table id="table-log" class="table table-striped">
          ...
          @foreach($logs as $key => $log)
            <tr data-display="stack{{{$key}}}"  style="border-color:#6f42c1">
...
<script src="/document/jquery.dataTables.min.js"></script>
<script src="/document/dataTables.bootstrap.js"></script>
<script>
